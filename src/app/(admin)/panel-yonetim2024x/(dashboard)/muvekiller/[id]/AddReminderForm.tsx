...
import { addClientReminder } from "../actions";

export default function AddReminderForm({ clientId }: { clientId: string }) {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const result = await addClientReminder(clientId, data);
      if (result?.success) {
        setOpen(false);
      } else {
